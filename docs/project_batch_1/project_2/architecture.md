...
style PIML fill:#161b22,stroke:#14b5ff,stroke-dasharray:6 6,color:#ffffff,rx:36,ry:36;
...
direction LR
    ...
    direction TB
        subgraph domain_norm["Domain Normalization"]
    ...
    direction LR
        apply_trapezoidal_weights["$$\int|\psi_n^\theta |\, dx=\sum{w_i |\psi_n^\theta |^2 \Delta x}$$"]:::norm
